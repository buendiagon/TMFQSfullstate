...
- Before concluding a local binary cannot be executed, check the repo's documented runtime setup in the README and CMake configuration. Project-local bootstrap requirements may exist even when the general docs imply RPATH coverage.
